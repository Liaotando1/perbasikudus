            ...
            <div class="sidebody">
                <div class="sidebodypart">
                    <ul>
                        ...
                        <li class="isActive"><a href="showatletsmaputra.php"><p>SMA Putra</p></a></li>
...
$querya = mysqli_query($conn,"SELECT * FROM atlit  where nama_sekolah like 'SMA%' and jenis_kelamin like 'LAKI-LAKI'"); 
