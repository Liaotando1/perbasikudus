            ...
            <div class="sidebody">
                <div class="sidebodypart">
                    <ul>
                        ...
                        <li class="isActive"><a href="showatletsmpputri.php"><p>SMP Putri</p></a></li>
...
$querya = mysqli_query($conn,"SELECT * FROM atlit  where nama_sekolah like 'SMP%' and jenis_kelamin like 'PEREMPUAN'"); 
