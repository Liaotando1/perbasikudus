...
<html lang="en">
    ...
    <body>
            ...
            <div class="sidebody">
                <div class="sidebodypart">
                    <ul>
                        ...
                        <li class="isActive"><a href="showatletsmpputra.php"><p>SMP Putra</p></a></li>
        ...
        <div id="dashboardData">
            ...
            <br>
            <td>  
                <input type="button" value="ADD ATLET" onClick="window.location.href='addatlet3x3.php'"> 
            </td>
            <br>
            <br>
...
?>
       <div align="center">
	     <table>
	  <tr bgcolor="#d3dce3">
	  <th width="300"><div align="center">NAMA ATLET</div></th>
	  <th width="300"><div align="center">NAMA TEAM</div></th>
	  <th width="300"><div align="center">FOTO</div></th>
	 </tr>
	      <?php
	$i=0;
		...
		?>
	      <tr align="center" bgcolor="<?php if($i%2==0) echo "#e5e5e5"; else echo "#d5d5d5";?>" style="cursor:pointer" onMouseOver="this.style.backgroundColor='#bbebc6';" onMouseOut="this.style.backgroundColor='<?php if($i%2==0) echo "#e5e5e5"; else echo "#d5d5d5";?>';">
	        ...
	        <td align="left">
              ...
              <img src="<?=$row[3]?>" width="45" height="60">	
              <br><a href='gambarlabgigi1.php?id=<?php echo $row[0] ?>&nama=<?php echo $row[1] ?>'>Edit FT</a>
              </td>
                    <td width="25">
                    <a class="style1"  style="cursor:pointer" onClick="window.location.href='belajar2.php?id=<?=$row[0]?>'"><img src="gambar/b_edit.png" width="24" height="23" /> </a>		</td>
                </td>
                <td width="44">
