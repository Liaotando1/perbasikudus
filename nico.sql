...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Nov 2019 pada 20.31
...
--
-- Struktur dari tabel `atlit`
--

CREATE TABLE `atlit` (
  `id_sekolah` int(10) NOT NULL,
  `nama_sekolah` varchar(192) NOT NULL,
  `tingkatan` varchar(192) NOT NULL,
  `id_atlit` int(10) NOT NULL,
  `nama_atlit` varchar(192) NOT NULL,
...
(1201, 12, 'NIAS'),
(1202, 12, 'MANDAILING NATA'),
(1203, 12, 'TAPANULI SELATA'),
...
(1215, 12, 'HUMBANG HASUNDU'),
(1216, 12, 'PAKPAK BHARAT'),
(1217, 12, 'SAMOSIR'),
(1218, 12, 'SERDANG BEDAGAI'),
(1219, 12, 'BATU BARA'),
(1220, 12, 'PADANG LAWAS UT'),
(1221, 12, 'PADANG LAWAS'),
(1222, 12, 'LABUHAN BATU SE'),
(1223, 12, 'LABUHAN BATU UT'),
(1224, 12, 'NIAS UTARA'),
(1225, 12, 'NIAS BARAT'),
(1271, 12, 'SIBOLGA'),
...
(1504, 15, 'BATANG HARI'),
(1505, 15, 'MUARO JAMBI'),
(1506, 15, 'TANJUNG JABUNG '),
(1507, 15, 'TANJUNG JABUNG '),
(1508, 15, 'TEBO'),
(1509, 15, 'BUNGO'),
(1571, 15, 'JAMBI'),
(1572, 15, 'SUNGAI PENUH'),
(1601, 16, 'OGAN KOMERING U'),
(1602, 16, 'OGAN KOMERING I'),
(1603, 16, 'MUARA ENIM'),
(1604, 16, 'LAHAT'),
(1605, 16, 'MUSI RAWAS'),
(1606, 16, 'MUSI BANYUASIN'),
(1607, 16, 'BANYU ASIN'),
(1608, 16, 'OGAN KOMERING U'),
(1609, 16, 'OGAN KOMERING U'),
(1610, 16, 'OGAN ILIR'),
(1611, 16, 'EMPAT LAWANG'),
(1612, 16, 'PENUKAL ABAB LE'),
(1613, 16, 'MUSI RAWAS UTAR'),
(1671, 16, 'PALEMBANG'),
(1672, 16, 'PRABUMULIH'),
(1673, 16, 'PAGAR ALAM'),
(1674, 16, 'LUBUKLINGGAU'),
(1701, 17, 'BENGKULU SELATA'),
...
(2103, 21, 'NATUNA'),
(2104, 21, 'LINGGA'),
(2105, 21, 'KEPULAUAN ANAMB'),
(2171, 21, 'B A T A M'),
(2172, 21, 'TANJUNG PINANG'),
(3101, 31, 'KEPULAUAN SERIB'),
...
(5302, 53, 'SUMBA TIMUR'),
(5303, 53, 'KUPANG'),
(5304, 53, 'TIMOR TENGAH SE'),
(5305, 53, 'TIMOR TENGAH UT'),
(5306, 53, 'BELU'),
(5307, 53, 'ALOR'),
(5308, 53, 'LEMBATA'),
...
(6171, 61, 'PONTIANAK'),
(6172, 61, 'SINGKAWANG'),
(6201, 62, 'KOTAWARINGIN BA'),
(6202, 62, 'KOTAWARINGIN TI'),
(6203, 62, 'KAPUAS'),
...
(6305, 63, 'TAPIN'),
(6306, 63, 'HULU SUNGAI SEL'),
(6307, 63, 'HULU SUNGAI TEN'),
(6308, 63, 'HULU SUNGAI UTA'),
(6309, 63, 'TABALONG'),
(6310, 63, 'TANAH BUMBU'),
(6311, 63, 'BALANGAN'),
(6371, 63, 'BANJARMASIN'),
...
(6401, 64, 'PASER'),
(6402, 64, 'KUTAI BARAT'),
(6403, 64, 'KUTAI KARTANEGA'),
(6404, 64, 'KUTAI TIMUR'),
(6405, 64, 'BERAU'),
(6409, 64, 'PENAJAM PASER U'),
...
(6504, 65, 'NUNUKAN'),
(6571, 65, 'TARAKAN'),
(7101, 71, 'BOLAANG MONGOND'),
(7102, 71, 'MINAHASA'),
(7103, 71, 'KEPULAUAN SANGI'),
(7104, 71, 'KEPULAUAN TALAU'),
(7105, 71, 'MINAHASA SELATA'),
(7106, 71, 'MINAHASA UTARA'),
(7107, 71, 'BOLAANG MONGOND'),
(7108, 71, 'SIAU TAGULANDAN'),
(7109, 71, 'MINAHASA TENGGA'),
(7110, 71, 'BOLAANG MONGOND'),
(7111, 71, 'BOLAANG MONGOND'),
(7171, 71, 'MANADO'),
(7172, 71, 'BITUNG'),
(7173, 71, 'TOMOHON'),
(7174, 71, 'KOTAMOBAGU'),
(7201, 72, 'BANGGAI KEPULAU'),
(7202, 72, 'BANGGAI'),
(7203, 72, 'MOROWALI'),
(7204, 72, 'POSO'),
(7205, 72, 'DONGGALA'),
...
(7307, 73, 'SINJAI'),
(7308, 73, 'MAROS'),
(7309, 73, 'PANGKAJENE DAN '),
(7310, 73, 'BARRU'),
(7311, 73, 'BONE'),
(7312, 73, 'SOPPENG'),
(7313, 73, 'WAJO'),
(7314, 73, 'SIDENRENG RAPPA'),
(7315, 73, 'PINRANG'),
(7316, 73, 'ENREKANG'),
(7317, 73, 'LUWU'),
(7318, 73, 'TANA TORAJA'),
...
(8101, 81, 'MALUKU TENGGARA'),
(8102, 81, 'MALUKU TENGGARA'),
(8103, 81, 'MALUKU TENGAH'),
(8104, 81, 'BURU'),
(8105, 81, 'KEPULAUAN ARU'),
(8106, 81, 'SERAM BAGIAN BA'),
(8107, 81, 'SERAM BAGIAN TI'),
(8108, 81, 'MALUKU BARAT DA'),
(8109, 81, 'BURU SELATAN'),
(8171, 81, 'AMBON'),
(8172, 81, 'TUAL'),
(8201, 82, 'HALMAHERA BARAT'),
(8202, 82, 'HALMAHERA TENGA'),
(8203, 82, 'KEPULAUAN SULA'),
(8204, 82, 'HALMAHERA SELAT'),
...
(9109, 91, 'TAMBRAUW'),
(9110, 91, 'MAYBRAT'),
(9111, 91, 'MANOKWARI SELAT'),
(9112, 91, 'PEGUNUNGAN ARFA'),
(9171, 91, 'SORONG'),
(9401, 94, 'MERAUKE'),
(9402, 94, 'JAYAWIJAYA'),
(9403, 94, 'JAYAPURA'),
...
--
-- AUTO_INCREMENT untuk tabel `atlit`
--
ALTER TABLE `atlit`
  MODIFY `id_atlit` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `kota`
--
ALTER TABLE `kota`
  MODIFY `id_kota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10001;
